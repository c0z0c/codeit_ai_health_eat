...
class Args_fasterrcnn:
    def __init__(self):
        ...
        self.checkpoint_path = "./checkpoints/FasterRCNN_resnet101/checkpoint_epoch_30.pth"
...
def main():
    ...
    if lower_model_name == 'fasterrcnn':
        ...
        trainer_fasterrcnn.main(args, model_name)
